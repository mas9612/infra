data "vsphere_resource_pool" "pool_33" {
  name          = "10.1.3.33/Resources"
  datacenter_id = "${data.vsphere_datacenter.dc_bachelor.id}"
}

data "vsphere_resource_pool" "pool_34" {
  name          = "10.1.3.34/Resources"
  datacenter_id = "${data.vsphere_datacenter.dc_bachelor.id}"
}
...
data "vsphere_resource_pool" "rp_k800123_34" {
  name          = "14-0499 Yamazaki"
  datacenter_id = "${data.vsphere_datacenter.dc_bachelor.id}"
}
...
resource "vsphere_resource_pool" "rp_tor34" {
  name                    = "k800123-tor34"
  parent_resource_pool_id = "${data.vsphere_resource_pool.rp_k800123_34.id}"
}
